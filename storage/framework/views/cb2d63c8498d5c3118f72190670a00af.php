    ...
    <div class="container my-5">
        ...
        <div class="card shadow-sm border-light">
            <div class="card-header bg-light">
                <h6 class="text-muted">Ditulis oleh: <?php echo e($berita->penulis); ?></h6>
                <p class="mb-0"><strong>Tanggal: </strong><?php echo e($berita->created_at->format('d M Y')); ?></p>
            </div>
            <div class="card-body">
                <p class="card-text"><?php echo e($berita->konten); ?></p> <!-- Menampilkan konten berita penuh -->
            </div>
        </div>

        <!-- Tombol kembali ke Dashboard -->
        <div class="text-center mt-4">
            <a class="btn btn-secondary" href="<?php echo e(route('dashboard')); ?>">Kembali ke Dashboard</a>
        </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjectSela\resources\views/userberita.blade.php ENDPATH**/ ?>